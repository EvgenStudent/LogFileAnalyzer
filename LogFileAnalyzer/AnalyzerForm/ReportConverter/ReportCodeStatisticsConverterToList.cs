...
{
	public class ReportCodeStatisticsConverterToList :
		IConverter<IEnumerable<CodeStatistics>, IEnumerable<CodeStatisticString>>
	{
		public IEnumerable<CodeStatisticString> Convert(IEnumerable<CodeStatistics> record)
		{
			IEnumerable<CodeStatisticString> list = record.Select(x => new CodeStatisticString
			{
